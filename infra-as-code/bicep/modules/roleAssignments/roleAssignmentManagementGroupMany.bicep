...
@sys.description('A list of management group scopes that will be used for role assignment (i.e. [zmoalz-platform-connectivity, zmoalz-platform-identity]). Default: Empty Array')
