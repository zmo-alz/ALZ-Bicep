...
The module requires the following inputs:
 ...
 | parVirtualWanName                       | string | `${parCompanyPrefix}-vwan-${resourceGroup().location}`                                                               | Name prefix for Virtual WAN.  Prefix will be appended with the region.                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | 2-50 char                                        | alz-vwan-norwayeast                                                                                                                          |
 | parVirtualWanHubName                       | string | `${parCompanyPrefix}-vhub-${resourceGroup().location}`                                                               | Name prefix for Virtual Hub.  Prefix will be appended with the region.                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | 2-50 char                                        | alz-vhub-norwayeast                                                                                                                          |
 | parVpnGatewayName                      | string | `${parCompanyPrefix}-vpngw-${resourceGroup().location}`                                                              | Name prefix for VPN Gateway.  Prefix will be appended with the region.                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | 2-50 char                                        | alz-vpngw-norwayeast                                                                                                                         |
 | parExpressRouteGatewayName                       | string | `${parCompanyPrefix}-ergw-${resourceGroup().location}`                                                               | Name prefix for ExpressRoute Gateway.  Prefix will be appended with the region.                                                                                                                                                                                                                                                                                                                                                                                                                                                             | 2-50 char                                        | alz-ergw-norwayeast                                                                                                                          |
 | parAzFirewallName              | string | `${parCompanyPrefix}-fw-${resourceGroup().location}`                                                                 | Name associated with Azure Firewall                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | 1-80 char                                        | alz-fw-norwayeast                                                                                                                            |
 | parAzFirewallPoliciesName           | string | `${parCompanyPrefix}-azfwpolicy-${resourceGroup().location}`                                                         | Name associated with Azure Firewall Policy                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | 1-80 char                                        | alz-azfwpolicy-norwayeast                                                                                                                    |
